...
If this script is not working well, please check your setting for system path and/or check your Python environment. When you run the "main_JP_Voicevox_tiny.py", it takes some second to receive the reply from the ChatBot.
